...
<body>
	...
	<table width="100%">
			...
			<tr>
				<td width="48%">
					<table width="100%" cellspacing="0" cellpadding="0">
						<tr >
							<td style="text-align:left; font-size:32px; line-height:34px; padding:0; margin:0px 0px 20px 0px">
								<strong style="font-size:.8em; line-height:.9em">Radni nalog:</strong><br/> {{$slucaj->stsrepairorderno}}<br />
								{!! (isset($slucaj->stsrepairorderno)) ? DNS1D::getBarcodeSVG($slucaj->stsrepairorderno, "C128", 2,25) : "" !!}
							</td>
						</tr>
						<tr>
							<td style="font-size:14px; line-height:20px; padding-top:10px; padding-bottom:5px;">
						...
						@if (!$zaprimanje)
						<tr>
						<td style="border:1px solid #ccc; border-bottom:0; padding:2px 5px">			<!-- ako je status samo ZAPRIMLJENO, onda se neispisuje!! -->
								<strong style="font-size:1.1em; line-height:1.1em">{{($slucaj->stsfailuredetected==1)? "Nedostatak uočen" 
									: 
						...
						<tr>
							<td style="border:1px solid #ccc;  padding:2px 5px">			<!-- ako je status samo ZAPRIMLJENO, onda se neispisuje!! -->
								@if (!$zaprimanje)
								<strong style="font-size:1.1em; line-height:1.1em">{{($slucaj->devicewarranty==1)? "Uređaj u jamstvu" : "Uređaj nije u jamstvu"}}</strong> 
								<br />
								@endif
				...
				<td style="border:1px solid #ccc; padding:0px 10px 10px 10px; font-size:14px" width="42%" >
					<h2 style="font-size:18px; font-weight:bold; padding:0px; line-height:18px; margin:0px 0px 5px 0px">Korisnik</h2>
					...
					<h2 style="font-size:18px; font-weight:bold; padding:10px 0px 0px 0px; line-height:18px; margin:0px 0px 5px 0px; border-top:1px solid #ccc">Mjesto predaje uređaja</h2>
		...
		<table width="100%" style="margin:30px 0px 20px 0px" cellpadding="0" cellspacing="0" >
			<tr >
				<td width="48%" valign="top" style="border:1px solid #ccc; padding:5px 10px; border-right:0">
					...
					{!!  (isset($slucaj->deviceincomingimei)) ? DNS1D::getBarcodeSVG($slucaj->deviceincomingimei, "C128", 2,25) :"" !!}<br />
					</div>
					<div style="border-top:1px solid #ccc">
					@if ($zaprimanje)
					Izlazni IMEI/SN: /<br />
				...
				<td width="24%" valign="top" style="border:1px solid #ccc; padding:5px 10px; border-right:0">
		...
		<table width="100%" style="margin:20px 0px 15px 0px" cellpadding="0" cellspacing="0" >
			<tr >
				...
				@if($dijeloviusluge)
				<td valign="top" width="50%" style="border:1px solid #ccc; border-left:0; padding:5px 10px 5px 10px; ">
					<h2 style="margin:0px 0px 5px 0px; font-size:14px; padding:0px">Dijelovi i usluge:</h2>
					<table width="100%" style="border:1px solid #999; padding:3px; " cellpadding="0" cellspacing="0">
						<tr>
							<th width="5%"  style="text-align:left; border-bottom:1px solid #ccc">rbr</th>
							<th width="45%" style="text-align:left; border-bottom:1px solid #ccc">naziv</th>
							<th width="15%" style="text-align:left; border-bottom:1px solid #ccc">jm</th>
							<th width="15%" style="text-align:left; border-bottom:1px solid #ccc">kol</th>
							<th width="20%" style="text-align:left; border-bottom:1px solid #ccc">uk.cijena</th>
						</tr>
						@foreach ($dijeloviusluge as $key => $value)
						<tr>
							<td style="border-top:1px solid #ccc">{{($key+1)."."}}</td>
	...
	<div style="border:1px solid #000; padding:10px; margin-top:20px">
		...
		@endif
		Dokument je izrađen elektronskim putem i pravovaljan je bez pečata.</div>
