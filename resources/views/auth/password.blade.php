...
<html lang="en">
  <head>
   ...
   <style>
        ...
        .form-signin input[type="email"]{margin-bottom:10px;border-top-left-radius:0;border-top-right-radius:0;}
...
<div class="account-wall">
                            ...
                            <form method="POST" action="/password/email" role="form" class="form-signin">
                                {!! csrf_field() !!}
...
@else
            ...
            <input type="email" name="email" placeholder="email adresa" class="form-control" value="{{ old('email') }}" />
            <input type="submit" class="btn btn-lg btn-primary btn-block" value="Pošalji link za reset"/>
